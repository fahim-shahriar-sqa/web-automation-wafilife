...
public class SigninPage extends BasePage{
    ...
    public By empty_email_error = By.xpath("//p[normalize-space()='You must need to provide your email address']");
    public String empty_email_error_txt = "You must need to provide your email address";
    public By empty_password_error = By.xpath("//p[normalize-space()='You must need to provide your password']");
    public String empty_password_error_txt = "You must need to provide your password";
